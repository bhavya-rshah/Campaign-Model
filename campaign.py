...
##############################################################
#you built a rule that says:Start with 5% undecided voters If you're slightly ahead, you get slightly more of them
#If you're behind, you get slightly fewer But the effect is capped so it doesn't go crazyConvert that into actual vote gain
...
# lean is basically how far from 50% are we
...
# -----------------------------------
# this line shows what percent of total voters from the undecided pool you get
